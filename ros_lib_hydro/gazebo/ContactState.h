#ifndef _ROS_gazebo_ContactState_h
#define _ROS_gazebo_ContactState_h
...
namespace gazebo
{
  ...
  class ContactState : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      offset += length_info;
      uint32_t length_geom1_name = strlen( (const char*) this->geom1_name);
      memcpy(outbuffer + offset, &length_geom1_name, sizeof(uint32_t));
      offset += 4;
      memcpy(outbuffer + offset, this->geom1_name, length_geom1_name);
      offset += length_geom1_name;
      uint32_t length_geom2_name = strlen( (const char*) this->geom2_name);
      memcpy(outbuffer + offset, &length_geom2_name, sizeof(uint32_t));
      offset += 4;
      memcpy(outbuffer + offset, this->geom2_name, length_geom2_name);
      offset += length_geom2_name;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_info;
      uint32_t length_geom1_name;
      memcpy(&length_geom1_name, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      for(unsigned int k= offset; k< offset+length_geom1_name; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_geom1_name-1]=0;
      this->geom1_name = (char *)(inbuffer + offset-1);
      offset += length_geom1_name;
      uint32_t length_geom2_name;
      memcpy(&length_geom2_name, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      for(unsigned int k= offset; k< offset+length_geom2_name; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_geom2_name-1]=0;
      this->geom2_name = (char *)(inbuffer + offset-1);
      offset += length_geom2_name;
    ...
    const char * getType(){ return "gazebo/ContactState"; };
    const char * getMD5(){ return "7f688fc24d90d16872fdc9ea8c6e45ab"; };
