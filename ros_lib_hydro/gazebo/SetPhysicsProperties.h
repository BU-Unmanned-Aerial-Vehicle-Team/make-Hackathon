...
#include "gazebo/ODEPhysics.h"

namespace gazebo
{

static const char SETPHYSICSPROPERTIES[] = "gazebo/SetPhysicsProperties";
  ...
  class SetPhysicsPropertiesRequest : public ros::Msg
  {
    ...
    const char * getMD5(){ return "46d5128757a51ad3b4801be86612b17c"; };
