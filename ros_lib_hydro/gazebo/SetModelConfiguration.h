...
static const char SETMODELCONFIGURATION[] = "gazebo/SetModelConfiguration";

  class SetModelConfigurationRequest : public ros::Msg
  {
    public:
      char * model_name;
      char * test_urdf_param_name;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      uint32_t length_test_urdf_param_name = strlen( (const char*) this->test_urdf_param_name);
      memcpy(outbuffer + offset, &length_test_urdf_param_name, sizeof(uint32_t));
      offset += 4;
      memcpy(outbuffer + offset, this->test_urdf_param_name, length_test_urdf_param_name);
      offset += length_test_urdf_param_name;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += length_model_name;
      uint32_t length_test_urdf_param_name;
      memcpy(&length_test_urdf_param_name, (inbuffer + offset), sizeof(uint32_t));
      offset += 4;
      for(unsigned int k= offset; k< offset+length_test_urdf_param_name; ++k){
          inbuffer[k-1]=inbuffer[k];
      }
      inbuffer[offset+length_test_urdf_param_name-1]=0;
      this->test_urdf_param_name = (char *)(inbuffer + offset-1);
      offset += length_test_urdf_param_name;
    ...
    const char * getMD5(){ return "b97a1bf770916d4179ca5a389ae67a0a"; };
